# Working with 3 Hidden Layers of Any Neurons

Welcome to the project that builds a generic neural network trained using the gradient descent algorithm.

The implementation of this part ends by building the gradient descent that works with:

1. Any number of inputs.
2. 3 hidden layers with any number of hidden neurons.
